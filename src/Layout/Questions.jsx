          ...
          <span>
            ...
            <div className="question-item">
              ...
              {showAnswer.companies && <div className="answer">Premier Exterior Construction stands out from the competition with our 
                Premier Exterior Construction stands out by offering complete exterior and general construction services, not just one 
                specialty. Our experienced team handles everything from doors and windows to decks, patios, roofing repairs, and full exterior builds. 
                We focus on quality workmanship, clear communication, and dependable service on every project, big or small.</div>}
            </div>
            <div className="question-item">
              ...
              {showAnswer.qservices && <div className="answer">Premier Exterior Construction provides a wide range of welding services, including 
                Premier Exterior Construction provides a wide range of services including door and window installation, deck and patio construction, 
                roofing repairs, siding work, fencing, custom exterior projects, and general construction services. Whether it’s a repair, upgrade, or a 
                brand-new build, we handle it from start to finish.</div>}
            </div>
          </span>
        </div>
      </div>
